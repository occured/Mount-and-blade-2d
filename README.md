...
8. Add `CombatSceneBootstrap`, `CombatResolution`, and optional `CombatResultUI` to the combat scene, assign enemy + ally prefabs and spawn roots to instantiate combatants from the last encounter and return to overworld.
